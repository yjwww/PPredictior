...
with ssr as
 ...
 where date_sk = d_date_sk
       and d_date between cast('2001-08-15' as date) 
                  and (cast('2001-08-15' as date) +  INTERVAL '14 day')
       and store_sk = s_store_sk
 group by s_store_id)
 ,
 csr as
...
with ssr as
 ...
 where date_sk = d_date_sk
       and d_date between cast('2002-08-04' as date) 
                  and (cast('2002-08-04' as date) +  INTERVAL '14 day')
       and store_sk = s_store_sk
 group by s_store_id)
 ,
 csr as
...
with ssr as
 ...
 where date_sk = d_date_sk
       and d_date between cast('2000-08-10' as date) 
                  and (cast('2000-08-10' as date) +  INTERVAL '14 day')
       and store_sk = s_store_sk
 group by s_store_id)
 ,
 csr as
...
with ssr as
 ...
 where date_sk = d_date_sk
       and d_date between cast('1999-08-12' as date) 
                  and (cast('1999-08-12' as date) +  INTERVAL '14 day')
       and store_sk = s_store_sk
 group by s_store_id)
 ,
 csr as
...
with ssr as
 ...
 where date_sk = d_date_sk
       and d_date between cast('1998-08-29' as date) 
                  and (cast('1998-08-29' as date) +  INTERVAL '14 day')
       and store_sk = s_store_sk
 group by s_store_id)
 ,
 csr as
...
with ssr as
 ...
 where date_sk = d_date_sk
       and d_date between cast('1998-08-11' as date) 
                  and (cast('1998-08-11' as date) +  INTERVAL '14 day')
       and store_sk = s_store_sk
 group by s_store_id)
 ,
 csr as
...
with ssr as
 ...
 where date_sk = d_date_sk
       and d_date between cast('2000-08-27' as date) 
                  and (cast('2000-08-27' as date) +  INTERVAL '14 day')
       and store_sk = s_store_sk
 group by s_store_id)
 ,
 csr as
...
with ssr as
 ...
 where date_sk = d_date_sk
       and d_date between cast('1999-08-02' as date) 
                  and (cast('1999-08-02' as date) +  INTERVAL '14 day')
       and store_sk = s_store_sk
 group by s_store_id)
 ,
 csr as
